...
// Definición de la estructura para los videojuegos
struct vjuego {
	string nombre;
	int ranking;
	bool tipo;
...
// Definición de la estructura para las personas
struct persona {
	string nombre;
	int id_persona;
	vjuego juegos[TAMJ];
};
// Listas de nombres, juegos y desarrolladores
...
// Función para verificar si un nombre está repetido en el arreglo de personas
bool repetido(string n, persona *p, int cant) {
...
// Función para verificar si un nombre está repetido en el arreglo de videojuegos
bool repetido(string n, vjuego *j, int cant) {
	for (int i = 0; i < cant; i++) {
...
// Función para llenar datos de personas y videojuegos
void llenar(persona *p, vjuego *j, int cant_personas, int cant_juegos) {
	string n;
	for (int i = 0; i < cant_personas; i++) {
		...
		if (!repetido(n, p, i)) {
			...
			i--;// Si ya existe, decrementamos i para repetir el proceso y agregar una nueva persona.
		}
	}
}
// Función para llenar datos de videojuegos
void llenar(vjuego *j, int cant) {
	string n;
	for (int i = 0; i < cant; i++) {
		...
		if (!repetido(n, j, i)) {
			...
			i--;// Si ya existe, decrementamos i para repetir el proceso y agregar un nuevo juego.
		}
	}
}
// Función para imprimir personas y videojuegos
...
// Función para imprimir videojuegos
void imprimir(vjuego *j, int cant) {
...
// Función para imprimir ranking de juegos por persona
void valoracion(persona *p, int cant_personas) {
